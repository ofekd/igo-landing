...
*/
      ...
      function menu_focus(element, i) {
          ...
          var el_width = icon_width + $(element).find('.text').width() + 10;
          var left_pos = icon.offset().left - $('.nav').offset().left - el_width + icon_width;
      ...
      jQuery(document).ready(function ($) {
          ...
          menu_item.hover(
              function (e) {
                  ...
                  var icon_width = icon.width();
                  var el_width = icon_width + $(this).find('.text').width() + 10;
                  var left_pos = icon.offset().left - $('.nav').offset().left - el_width + icon_width;
